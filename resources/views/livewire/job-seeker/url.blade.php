<div class="mb-4 space-y-4">
    <div>
        ...
        <x-text-input autocomplete="name" class="mt-1 w-full" id="{{ $inputName }}"
    ...
    <div>
        ...
        <x-text-input class="mt-1 w-full" id="{{ $inputSlug }}" maxlength="{{ $maxlength }}"
    ...
    <div>
        ...
        <x-text-input class="mt-1 w-full" id="{{ $inputUrl }}" name="{{ $inputUrl }}"
